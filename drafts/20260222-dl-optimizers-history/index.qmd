---
title: "From Momentum to Muon: How Deep Learning Optimizers Evolved"
date: 2026-02-22
...
Looking back from 2025, optimizer progress did not follow a single clean line. It came in waves: acceleration, adaptivity, regularization corrections, systems scaling, and now geometry-aware updates.
...
## Practical recipes (2025-ish)

If I want stable baselines fast:
...
By 2025, AdamW remained the center of gravity for large language and multimodal models, but geometry-aware methods suggest the next wave may come from better directional control rather than only better scalar learning-rate heuristics.
