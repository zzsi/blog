...
- **Layer: measurement.** Three-level evals. Where the bottleneck actually sits is contested, and you cannot tell which reading applies to you without measuring. [REUSE: relocated bottleneck para] Verifiers fail in two directions. [REUSE: first-hand verifier story]
...
- fig3 J-curve — **needs rework**: currently labeled use/customize/own.
