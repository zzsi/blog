...
![Illustrative coverage-versus-error curve. As automation coverage increases, the error rate among automated cases also rises.](coverage-vs-error.svg){width=760px fig-align="center"}

Moving the confidence threshold to automate more documents lets more errors through. The shape of this curve, not a single accuracy number, is what determined whether a system was production-ready.
