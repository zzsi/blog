...
I was intrigued to see this example where a variety (at least 5) computer vision techniques to create visual appealing analytics from soccer game footage. Soccer fans and coaches may enjoy this.
...
:::{.callout-note title="Install" collapse="false" icon="false" appearance="default"}
...
:::{.callout-note title="Run the code" collapse="false" icon="false" appearance="default"}
### Step 3: Run the code
```
...
![With one prompt, Grounding DINO was able to detect players but had a hard time distinguishing the goal keeper from other players.](result_grounding_dino_soccer_goalie.png){width=550px, fig-align="left"}
