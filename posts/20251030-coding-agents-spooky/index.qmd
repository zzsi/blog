...
I ran four different coding agents (Codex, Composer, Claude, and Gemini) on the Spooky Author Identification task. Each agent is allowed to run 10 iterations. Each agent ended up spending somewhere from 2.5 hours to 13 hours having fun on my mac mini. Here's what I learned:
