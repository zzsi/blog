...
**Example folder**: [`examples/mcp-readonly-starter`](../../examples/mcp-readonly-starter)
...
**Example folder**: [`examples/mcp-multitenant-saas`](../../examples/mcp-multitenant-saas)
...
**Example folder**: [`examples/mcp-write-with-approval`](../../examples/mcp-write-with-approval)
...
**Example folder**: [`examples/mcp-onprem-bridge`](../../examples/mcp-onprem-bridge)
...
**Example folder**: [`examples/mcp-compliance-audit`](../../examples/mcp-compliance-audit)
