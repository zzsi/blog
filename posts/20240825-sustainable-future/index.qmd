...
Since the advent of the free market, human society has experienced an unprecedented wave of growth and prosperity. Global GDP has increased [100-fold](https://ourworldindata.org/grapher/global-gdp-over-the-long-run), with per-capita GDP rising [15-fold](https://ourworldindata.org/grapher/gdp-per-capita-maddison?tab=chart) since the early 1800s. However, this tremendous growth has exacted a significant toll on the environment. As we stand on the brink of another nascent revolution, artificial intelligence (AI) promises to usher in a second wave of growth—this time, much more sustainable. Could AI help us achieve the elusive goal of expanding our economies while preserving the planet?
...
![Ariel picture of the tire graveyard in Kuwait. Final resting place of over 7,000,000 rubber tires. Source: [@Wolf of X](https://x.com/tradingMaxiSL/status/1827755833733615850)](GV2MH78WwAA16WR.jpeg){width=500px fig-align="left"}
